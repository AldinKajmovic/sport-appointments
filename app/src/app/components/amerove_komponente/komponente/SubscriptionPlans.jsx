...
const SubscriptionCard = ({ title, price, features, image, text }) => {
    return (
        ...
        >
            <div style={{ backgroundImage: `url(${image.src})`, backgroundSize: 'cover', backgroundPosition: 'center', height:300 }} />
            <CardContent>
                <Typography variant="h6" component="div" sx={{ textAlign: 'center', marginBottom: 2, marginTop: 3 }}>
                    {title}
                </Typography>
