...
export default function TeamCard({key,name,leader,sport,foundation,team_players}) {
  ...
  return (
    <Card sx={{ display: 'flex',
      ...
      <Typography sx={{ padding: 1, paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 500 }}> 
        ...
        <Typography component="span" sx={{ paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 400, fontSize: '95%', align: 'justify'  }}>  {leader} </Typography>
      </Typography>
        <Divider/> 
        <Typography sx={{ padding: 1, paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 500 }}> 
        {content[language].sport}  
        <Typography component="span" sx={{ paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 400, fontSize: '95%', align: 'justify'  }}> {sport}</Typography>
      </Typography>
        <Divider/> 
        <Typography sx={{ padding: 1, paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 500 }}> 
        {content[language].foundation} 
        <Typography component="span" sx={{ paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 400, fontSize: '95%', align: 'justify'  }}> {foundation} </Typography>
      </Typography>
      <Divider/> 
      </CardContent>
      <CardActions sx={{ paddingTop: 2 }}>
  <Typography sx={{ paddingLeft: 2, fontFamily: 'Ubuntu, sans-serif', fontWeight: 500 }}>
    {content[language].team_players}
  </Typography>
  <ExpandMore
    expand={expanded}
