        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              ...
              <MenuItem key={content[language].page_section_3} onClick={handleOpenTimovi}>
          ...
          <Box sx={{ justifyContent: 'center', flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button
                key={content[language].page_section_3}
                onClick={handleOpenTimovi}
                sx={{ my: 2, color: 'black', display: 'block' }}
              >
                {content[language].page_section_3}
              </Button>
          </Box>
